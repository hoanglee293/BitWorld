        ...
        <div className="h-full flex flex-col relative">
            ...
            <div className="flex-none flex h-[30px] bg-gray-300 my-3 mx-3 rounded-full relative dark:bg-theme-neutral-800">
                {walletInfor?.role === "master" && (
                    <button
                        className={`flex-1 rounded-xl text-sm cursor-pointer font-medium uppercase text-center ${activeTab === "trade" ? "bg-theme-primary-500" : "text-neutral-400"
                            }`}
                ...
                <button
                    className={`flex-1 rounded-xl cursor-pointer text-sm font-medium uppercase text-center ${activeTab === "chat" ? "bg-theme-primary-500" : "text-neutral-400"
                        }`}
