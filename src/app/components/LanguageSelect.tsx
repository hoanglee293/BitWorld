  ...
  return (
    <DropdownMenu >
      <DropdownMenuTrigger className={className} asChild>
        <Button variant="ghost" size="icon" className="w-full dark:bg-transparent bg-gray-100 dark:text-theme-neutral-100 text-theme-neutral-800 px-2 flex justify-start gap-2">
      ...
      <DropdownMenuContent align="end" className={`${showArrow ? '!bg-theme-primary-500/40 border-t border-neutral-200 dark:border-transparent rounded-md box-shadow-none rounded-t-none' : ''}`}>
