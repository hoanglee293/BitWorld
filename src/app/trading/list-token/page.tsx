            ...
            <div className='pr-1 h-full'>
                ...
                >
                    <div className="flex gap-2">
                        <button
                            className={`text-xs cursor-pointer p-1 px-3 rounded-md font-normal shrink-0 ${activeTab === "trending" ? "text-theme-neutral-100 bg-theme-primary-500" : "dark:text-theme-neutral-100"}`}
