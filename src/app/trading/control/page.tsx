...
const classLayout = "dark:bg-theme-neutral-1000 shadow-inset bg-white rounded-lg flex flex-col"
  ...
  return (
    <div className='flex flex-col h-full gap-4 '>
      <PanelGroup direction="vertical" className="h-full">
        {/* Chart Panel */}
        <Panel defaultSize={50} minSize={20} maxSize={80} className={`${classLayout} lg:overflow-hidden relative`}>
