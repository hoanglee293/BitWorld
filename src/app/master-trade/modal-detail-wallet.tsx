        ...
        <div className="flex gap-4 flex-col flex-1 overflow-y-auto mt-4">
          ...
          <div className="flex px-4 justify-end">
            <div className="flex rounded-full border-gray-200 dark:border-neutral-800 h-[35px] bg-gray-100 dark:bg-theme-neutral-1000">
              <button
                className={`flex-1 rounded-full px-6 min-w-[150px] text-sm cursor-pointer font-medium uppercase text-center ${activeTab === "DETAILS" ? "bg-blue-500 text-white bg-theme-primary-500" : "text-gray-500 dark:text-neutral-400"}`}
                onClick={() => setActiveTab("DETAILS")}
              >
                {t("masterTrade.page.table.details")}
              </button>
              <button
                className={`flex-1 rounded-full px-6 min-w-[150px]  cursor-pointer text-sm font-medium uppercase text-center ${activeTab === "CHAT" ? "bg-blue-500 text-white bg-theme-primary-500" : "text-gray-500 dark:text-neutral-400"}`}
