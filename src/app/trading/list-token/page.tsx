            ...
            <div className='pr-1 h-full'>
                ...
                >
                    <div className="flex gap-2">
                        <button
                            className={`text-xs cursor-pointer p-1 px-3 rounded-xl font-normal shrink-0 ${activeTab === "trending" ? "text-theme-neutral-100 bg-theme-primary-500 bg-theme-primary-500" : "dark:text-theme-neutral-100"}`}
                            onClick={() => handleTabChange("trending")}
                        >
                            {t('trading.listToken.trending')}
                        </button>
                        <button
                            className={`flex items-center gap-1 text-xs cursor-pointer p-1 px-3 rounded-xl font-normal shrink-0 ${activeTab === "new" ? "text-theme-neutral-100 bg-theme-primary-500 bg-theme-primary-500" : "dark:text-theme-neutral-100"}`}
                            onClick={() => handleTabChange("new")}
                        >
                            {t('trading.listToken.new')} <PumpFun />
                        </button>
                        <button
                            className={`text-xs cursor-pointer p-1 px-3 rounded-xl font-normal shrink-0 ${activeTab === "favorite" ? "text-theme-neutral-100 bg-theme-primary-500 bg-theme-primary-500" : "dark:text-theme-neutral-100"}`}
                            onClick={() => handleTabChange("favorite")}
                        >
                            {t('trading.listToken.favorite')}
                        </button>
                        <button
                            className={`text-xs cursor-pointer p-1 px-3 rounded-xl font-normal shrink-0 ${activeTab === "category" ? "text-theme-neutral-100 bg-theme-primary-500 bg-theme-primary-500" : "dark:text-theme-neutral-100"}`}
                ...
                {activeTab !== "favorite" && activeTab !== "new" && (
                    <div>
                        <div className="flex border-t border-b py-1 border-neutral-700 w-full">
                            <button
                                className={`text-[10px] cursor-pointer p-[2px] px-3 rounded-xl font-normal shrink-0 ${timeFilter === "5m" ? "text-theme-neutral-100 bg-theme-primary-500 bg-theme-primary-500" : "dark:text-theme-neutral-100"}`}
                                onClick={() => setTimeFilter("5m")}
                            >
                                {t('tokenInfo.timeFrames.5m')}
                            </button>
                            <button
                                className={`text-[10px] cursor-pointer p-[2px] px-3 rounded-xl font-normal shrink-0 ${timeFilter === "1h" ? "text-theme-neutral-100 bg-theme-primary-500 bg-theme-primary-500" : "dark:text-theme-neutral-100"}`}
                                onClick={() => setTimeFilter("1h")}
                            >
                                {t('tokenInfo.timeFrames.1h')}
                            </button>
                            <button
                                className={`text-[10px] cursor-pointer p-[2px] px-3 rounded-xl font-normal shrink-0 ${timeFilter === "4h" ? "text-theme-neutral-100 bg-theme-primary-500 bg-theme-primary-500" : "dark:text-theme-neutral-100"}`}
                                onClick={() => setTimeFilter("4h")}
                            >
                                {t('tokenInfo.timeFrames.4h')}
                            </button>
                            <button
                                className={`text-[10px] cursor-pointer p-[2px] px-3 rounded-xl font-normal shrink-0 ${timeFilter === "24h" ? "text-theme-neutral-100 bg-theme-primary-500 bg-theme-primary-500" : "dark:text-theme-neutral-100"}`}
